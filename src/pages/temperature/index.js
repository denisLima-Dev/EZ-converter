...
class Temperature extends Component {
  ...
  Convert = {
    c: (val) => {
      return {
        c: this.prepareNumber(val),
        f: this.truncateValue((val * 9) / 5 + 32),
    ...
    f: (val) => {
      return {
        f: this.prepareNumber(val),
        c: this.truncateValue(((val - 32) * 5) / 9),
    ...
    k: (val) => {
      return {
        k: this.prepareNumber(val),
        c: this.truncateValue(val - 273.15),
        ...
        <View style={{ height: "100%" }}>
          ...
          >
            ...
            >
              <TouchableWithoutFeedback
                onPress={() => {
                  this.setState({ value: 0, unitInUse: "c" });
                  this.openKeyboard();
                }}
              >
                <View
              ...
              <TouchableWithoutFeedback
                onPress={() => {
                  this.setState({ value: 0, unitInUse: "f" });
                  this.openKeyboard();
                }}
              >
                <View
              ...
              <TouchableWithoutFeedback
                onPress={() => {
                  this.setState({ value: 0, unitInUse: "k" });
                  this.openKeyboard();
                }}
              >
                <View
